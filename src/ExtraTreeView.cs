...
namespace DataMaker
{
    ...
    [Serializable]
    public partial class ExtraTreeView : TreeView
    {
        #region 成员变量
        ///<summary>
        /// 存储多选时选择的节点
        ...
        protected override void OnDragDrop(DragEventArgs drgevent)
        {
            ...
            var targetNode = GetNodeAt(point);
            ...
            if (!moveNode.Equals(targetNode) && !containsNode(moveNode, targetNode))
            {
                ...
                TreeNodeCanAcceptDragedHandler?.Invoke(moveNode, targetNode);
            }
        }
